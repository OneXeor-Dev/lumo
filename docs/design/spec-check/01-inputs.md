...
lumo-spec check --layout screen.json \
                --source jira \
                --url 'https://acme.atlassian.net/browse/APP-1234'
...
| `LUMO_ANTHROPIC_BASE_URL` | Optional. Anthropic-compatible proxy URL (LiteLLM, Bedrock, self-hosted gateway). |
...
distribution of representative Confluence / Jira specs, measured during
